...
public class Module_file extends HTTPDModule
{
    ...
    private final File rootDir = new File(UniverseMG.plugin.config.getString("httpd.public_folder"));
    ...
    public Module_file(UniverseMG plugin, NanoHTTPD.HTTPSession session)
    {
