...
public class Command_modchat implements UMGCommand
{
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args)
    {
        ...
        if(args.length == 0)
        {
            ...
            {
                plugin.playerChats.put((Player)sender, ChatType.MODERATOR);
                sender.sendMessage(ChatColor.RED + "Toggled modchat ON");
            }
            else
            {
                plugin.playerChats.remove((Player)sender);
                sender.sendMessage(ChatColor.RED + "Toggled modchat OFF");
            }
        ...
        ChatUtils.specialChatMessage((Player) sender, message, ChatType.MODERATOR);
